...
import { ITaxonomyPickerWebPartProps } from '../TaxonomyPickerWebPart';
...
export default class TermsPickerComponent extends React.Component<ITermPickerProps, ISelectTermsState, ITaxonomyPickerProps> {
    ...
    public async GetTerms(): Promise<any> {
        ...
        try {
            //Taxonomy_XzKxG6/fNVQT5M8e7tpT1g== 
            //const store: ITermStore = await taxonomy.termStores.getByName("Taxonomy_AOX/6GLQ+uXjVRyf3qacGA==");
            //Dennis - Taxonomy_XzKxG6/fNVQT5M8e7tpT1g==; e097241c-1ec5-42f5-accb-0c9ac70f8c43
            
            
            const store: ITermStore = await taxonomy.termStores.getByName("Taxonomy_XzKxG6/fNVQT5M8e7tpT1g==");
            const setWithData = await store.getTermSetById('e097241c-1ec5-42f5-accb-0c9ac70f8c43'); // this.props.TermSetId*/
            /*const store: ITermStore = await taxonomy.termStores.getByName("Taxonomy_XzKxG6/fNVQT5M8e7tpT1g==");
            const setWithData = await store.getTermSetById('e097241c-1ec5-42f5-accb-0c9ac70f8c43');*/
